...
- активных EnvironmentRequest: `2`;
- активных generated environments: `2`;
- работающих tenant VM: `1`;
...
`app-only` и состояние `Ready`; виртуальная машина для него не создавалась.
