...
main{padding:26px}.heading{display:flex;justify-content:space-between;align-items:end;margin-bottom:18px}h1{font-size:27px;margin:0 0 5px}.muted{color:#6b7f92}.kpis{display:grid;grid-template-columns:repeat(5,1fr);gap:14px;margin-bottom:18px}.kpi,.panel{background:#fff;border:1px solid #dce3ea;border-radius:8px;box-shadow:0 1px 2px #142b4410}.kpi{padding:16px}.kpi b{font-size:28px;display:block;margin-top:12px}.toolbar{display:flex;gap:10px;padding:14px}.toolbar input,.toolbar select,.dialog textarea{border:1px solid #b8c5d1;border-radius:6px;padding:9px;font:inherit}.toolbar input{flex:1}.table-wrap{overflow:auto}table{width:100%;border-collapse:collapse}th,td{padding:12px 14px;border-top:1px solid #e7ecf1;text-align:left;white-space:nowrap}th{color:#6b7f92;font-size:12px}.badge{padding:4px 8px;border-radius:12px;background:#eaf3ff;color:#0969d7;font-weight:750;font-size:12px}.badge.Ready{background:#e5f7f1;color:#08785a}.badge.Error,.badge.ActionFailed{background:#fde9e9;color:#ad2929}.menu button,.secondary{border:1px solid #b8c5d1;background:#fff;border-radius:6px;padding:7px 10px}.danger{background:#c93535;color:#fff;border:0;border-radius:6px;padding:9px 14px}.modal{position:fixed;inset:0;background:#10203388;display:none;place-items:center;padding:20px}.modal.open{display:grid}.dialog{background:#fff;border-radius:8px;padding:22px;width:min(540px,100%)}.dialog textarea{width:100%;min-height:90px}.warning{background:#fff4e4;border-left:3px solid #d98b15;padding:12px;margin:14px 0}.actions{display:flex;justify-content:flex-end;gap:10px}.mono{font-family:ui-monospace,monospace}
@media(max-width:900px){.app{grid-template-columns:1fr}aside{position:static;height:auto}.kpis{grid-template-columns:repeat(2,1fr)}.top{padding:0 16px}main{padding:18px}}
