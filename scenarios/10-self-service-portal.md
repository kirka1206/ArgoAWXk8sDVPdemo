...
Показать, как разработчик создаёт тестовый стенд через web UI, но GitOps остаётся источником правды.
...
Профиль стенда — это не свободная форма заказа ресурсов, а заранее утверждённый шаблон.
